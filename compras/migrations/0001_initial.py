    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descuento_pre_iva', models.FloatField(default=0)),
                ('descuento_pos_iva', models.FloatField(default=0)),
                ('iva', models.IntegerField(default=0)),
                ('flete', models.DecimalField(decimal_places=4, max_digits=6)),
        ...
        migrations.AddField(
            model_name='compra',
            name='estado',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='compras.estadocompra'),
        ),
        migrations.AddField(
            model_name='compra',
            name='forma_pago',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='baseapp.formapago'),
        ),
        migrations.AddField(
            model_name='compra',
            name='proveedor',
